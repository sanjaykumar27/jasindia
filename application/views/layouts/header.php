                ...
                <ul class="navbar-nav  mb-2 mb-lg-0 ms-auto">
                    <li class="nav-item dropdown ms-2">
                        ...
                        <ul class="dropdown-menu signout-dropdown" aria-labelledby="navbarDropdown">
                            ...
                            <li><a href="<?php echo base_url() ?>master/emission_standard_description"
                                    class="dropdown-item">
                                    Emission Standard Description
                                </a></li><li><a href="<?php echo base_url() ?>master/exclusion_mapping"
                                    class="dropdown-item">
                                    Exclusion Mapping
                                </a></li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle px-2 ms-2" href="#" id="navbarDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            Admin
                        </a>
                        <ul class="dropdown-menu signout-dropdown" aria-labelledby="navbarDropdown">
